...
Logic variables are istances of <code>lvarT</code> not vectors as they are Scheme.
...
Currently the <code>Substitutions</code> uses <code>clojure.lang.PersistentHashMap</code> internally. This will probably be substituted with something more suitable for triangular substitutions. I'll be investigating Skew Binary Random Access Lists as well as Finger Trees (Okasaki).

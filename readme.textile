...
The chunk that remains the unchanged from the implementation found in the disseration is the code relating to goals and goal constructors. There's quite a bit of clever macro magic there which makes miniKanren code efficient.

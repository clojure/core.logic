...
The design of miniKanren currently suffer from the closed principle. Relations are primarily defined through functions and so they are at the moment hard to extend. It would be preferable for the syntax to be more "open". Consider the following Prolog snippet:
